...
const Breadcrumbs = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <DocsComponents href="components/beBreadcrumb/" />
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              The beBreadcrumb navigation provides links back to each previous page the user navigated
            ...
            <DocsExample href="components/beBreadcrumb">
              <CBreadcrumb>
                <CBreadcrumbItem>
