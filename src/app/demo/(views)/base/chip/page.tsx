...
import { CCard, CCardBody, CCardHeader, CChip, CCol, CRow } from '@coreui/react-pro'
    ...
    <CRow>
      <CCol xs={12}>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              Add <code>variant=&quot;outline&quot;</code> to create a lighter, bordered
              appearance.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/chip/#chips-with-avatars">
              <div className="d-flex flex-wrap gap-2">
                <CChip>
                  <img className="rounded-circle me-2" src={Avatar1.src} width="16" height="16" alt="" />{' '}
                  Olivia Martin
                </CChip>
                <CChip>
                  <img className="rounded-circle me-2" src={Avatar4.src} width="16" height="16" alt="" />{' '}
                  Ethan Carter
                </CChip>
                <CChip>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Use the <code>color</code> prop for contextual variants and the <code>size</code>{' '}
